...
function Login() {
  ...
  return (
    ...
    <div style={{position:'relative', backgroundColor:'black', left:'13vw', display:'grid', justifyItems:'center', border:'solid', paddingBottom:'7vh', width:'35vw', height:'30vh', borderRadius:'10px'}}>
